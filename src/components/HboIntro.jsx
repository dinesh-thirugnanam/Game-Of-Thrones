...
const HboIntro = () => {
  ...
  const audioRefs = {
    stark: useRef(new Audio("/audio/Game Of Thrones House Stark Theme.mp3")),
    targaryen: useRef(new Audio("/audio/Game Of Thrones House Targaryan Theme.mp3")),
    lannister: useRef(new Audio("/audio/Game Of Thrones House Lannister Theme.mp3")),
  };
  ...
  const handleHoverStart = (house) => {
    ...
    if (audio) {
      ...
      audio.play().catch((err) => console.error(`Failed to play ${house} audio`, err));
      fadeAudio(audio, "in");
    }
  };
      ...
      {isVideoVisible && (
        <video
          ...
          className={`w-full h-full transition-all duration-1000 ease-in-out ${
            hboPlay ? "scale-150 opacity-0" : "scale-100 opacity-100"
          }`}
          autoPlay
          muted
          ...
          <div className="relative text-center">
            ...
            <div className="flex w-full justify-around px-10 mt-10 font-got">
              ...
              >
                ...
                />
                <div className="group-hover:opacity-100 group-hover:mt-2 -mt-2 opacity-0 duration-1000 delay-200 transition-all text-wrap w-40">"WINTER IS COMING"</div>
              </button>
              <button
                className="hover:scale-125 pb-2 group transition-all duration-200 h-[60vh] bg-black/20 rounded-b-2xl shadow-2xl shadow-black flex flex-col items-center"
              ...
              >
                ...
                />
                <div className="group-hover:opacity-100 group-hover:mt-2 -mt-2 opacity-0 duration-1000 delay-200 transition-all text-wrap w-40">"BLOOD OF MY BLOOD"</div>
              </button>
              <button
                className="hover:scale-125 pb-2 group transition-all duration-200 h-[60vh] bg-black/20 rounded-b-2xl shadow-2xl shadow-black flex flex-col items-center"
              ...
              >
                ...
                />
                <div className="group-hover:opacity-100 group-hover:mt-2 -mt-2 opacity-0 duration-1000 delay-200 transition-all text-wrap w-40">"A LANNISTER ALWAYS PAYS HIS DEBTS"</div>
              </button>
            </div>
          </div>
        </div>
